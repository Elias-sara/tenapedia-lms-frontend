...
const Toast = ({ 
  ...
  return (
    <div className="fixed bottom-0 right-0 flex items-end justify-center px-4 py-6 pointer-events-none sm:p-6">
      <Transition
        show={isVisible}
      ...
      >
        <div className="max-w-sm w-full shadow-lg rounded-lg pointer-events-auto">
          <div className={`rounded-lg ring-1 ring-black ring-opacity-5 overflow-hidden ${colors[type]}`}>
            <div className="p-4">
